    ...
    public function processCheckout(Request $request)
    {
        ...
        try {
            ...
            $data = $request->validate([
                ...
                'payment_method' => 'required|in:transfer,Cash on Delivery,midtrans',
            ...
            // Jika payment_method midtrans, generate snap token
            if ($data['payment_method'] === 'midtrans') {
                ...
                return response()->json([
                    'success' => true,
                    'message' => 'Order berhasil dibuat! Redirect ke Midtrans...',
                    'order_id' => $order->id,
