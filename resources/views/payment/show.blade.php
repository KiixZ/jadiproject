                ...
                <div class="bg-white border border-gray-200 rounded-lg p-4">
                    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center">
                        <div class="space-y-1 mb-4 sm:mb-0">
                            ...
                            <p class="text-gray-600">a.n <span class="font-medium text-gray-900">Ahmad Syaifuddin <br> (CEO AlfazaGrilled Indonesia)</span></p>
                        </div>
...
@if($order->payment_method === 'midtrans')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            fetch('/api/get-snap-token?order_id={{ $order->id }}')
                    ...
                    if (data.snap_token) {
                        window.snap.pay(data.snap_token, {
                            ...
                            onPending: function(result){ 
                                window.location.href = '/orders/pending/{{ $order->id }}';
                            },
