        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                <li class="breadcrumb-item text-sm">
                    <a class="opacity-5 text-dark" href="{{ route('admin.dashboard') }}">Halaman</a>
                </li>
                @if (Request::routeIs('admin.dashboard'))
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Dashboard</li>
                @elseif (Request::routeIs('admin.pengguna.index'))
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Pengguna</li>
                @elseif (Request::routeIs('admin.produk.kategori'))
                    <li class="breadcrumb-item text-sm">
                        <a class="opacity-5 text-dark" href="{{ route('admin.produk.index') }}">Produk</a>
                    </li>
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Kategori Produk</li>
                @elseif (Request::routeIs('admin.produk.index'))
                    <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Produk</li>
                @elseif (Request::routeIs('admin.pesanan.index'))
